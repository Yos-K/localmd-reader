...
sh "$ROOT/scripts/test-play-store-listing-current.sh"
sh "$ROOT/scripts/test-play-store-listing-workflow.sh"
sh "$ROOT/scripts/test-theme-screenshot-anr-recovery.sh"
...
python3 "$ROOT/scripts/test_play_update_listing_auth.py"
