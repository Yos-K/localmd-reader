...
public final class MarkdownHeadingTest {
    ...
    final class LevelValidity {
        ...
        void levelZeroIsRejected() {
            TestAssertions.assertThrows(IllegalArgumentException.class, () -> new MarkdownHeading(0, "Title", "title"));
        }

        @Test
        void levelSevenIsRejected() {
            TestAssertions.assertThrows(IllegalArgumentException.class, () -> new MarkdownHeading(7, "Title", "title"));
        }
    }

    @Nested
    final class TextValidity {
        @Test
        ...
        void nullTitleIsRejected() {
            TestAssertions.assertThrows(IllegalArgumentException.class, () -> new MarkdownHeading(1, null, "title"));
        }

        @Test
        void blankTitleIsRejected() {
            TestAssertions.assertThrows(IllegalArgumentException.class, () -> new MarkdownHeading(1, "   ", "title"));
        }

        @Test
        void nullAnchorIdIsRejected() {
            TestAssertions.assertThrows(IllegalArgumentException.class, () -> new MarkdownHeading(1, "Title", null));
        }
    ...
    @Nested
    final class ValidLevelBoundaries {
        @Test
