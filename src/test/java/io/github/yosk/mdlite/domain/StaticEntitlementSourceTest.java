...
public final class StaticEntitlementSourceTest {
    public static void main(String[] args) {
        freeSourceReturnsFreeEntitlement();
        proSourceReturnsProEntitlement();
        missingEntitlementSourceFallsBackToFreeEntitlement();
    }

    private static void freeSourceReturnsFreeEntitlement() {
    ...
    private static void proSourceReturnsProEntitlement() {
