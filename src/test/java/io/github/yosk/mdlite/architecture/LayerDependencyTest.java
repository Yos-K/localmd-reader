...
public final class LayerDependencyTest {
    ...
    @Nested
    final class AndroidFrameworkBoundary {
        @Test
    ...
    @Nested
    final class InternalDependencyDirection {
        @Test
        void domainPackageMustNotDependOnOtherInternalLayers() {
            ArchRule rule =
                    noClasses()
                            ...
                            .should()
                            .dependOnClassesThat()
                            .resideInAnyPackage("..infrastructure..", "..viewer..", "..file..", "..presentation..");
            rule.check(productionClasses);
        }
        ...
        void layersMustNotFormCyclicDependencies() {
            ArchRule rule = slices().matching(ROOT + ".(*)..").should().beFreeOfCycles();
            rule.check(productionClasses);
        }
