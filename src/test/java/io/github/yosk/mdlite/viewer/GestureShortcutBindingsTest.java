...
public final class GestureShortcutBindingsTest {
    @Nested
    final class AssignmentUniqueness {
        @Test
        void assigningAnActiveActionToAnotherGestureMovesItInsteadOfDuplicatingIt() {
            GestureShortcutBindings bindings =
                    GestureShortcutBindings.empty()
                            .put(GestureShortcutBinding.of(
                                    GestureShortcutTrigger.doubleTap(), GestureShortcutAction.openMenu()))
                            .put(GestureShortcutBinding.of(
        ...
        void puttingSameTriggerReplacesPreviousAction() {
            GestureShortcutAction action = GestureShortcutBindings.empty()
                                                   .put(GestureShortcutBinding.of(GestureShortcutTrigger.circle(),
                                                           GestureShortcutAction.openMenu()))
                                                   .put(GestureShortcutBinding.of(GestureShortcutTrigger.circle(),
                                                           GestureShortcutAction.nextTab()))
            ...
            GestureShortcutBindings bindings =
                    GestureShortcutBindings.empty()
                            .put(GestureShortcutBinding.of(
                                    GestureShortcutTrigger.doubleTap(), GestureShortcutAction.openMenu()))
                            .put(GestureShortcutBinding.of(
                                    GestureShortcutTrigger.circle(), GestureShortcutAction.nextTab()));

            TestAssertions.assertEquals(
                    2, bindings.items().size(), "different triggers must produce separate bindings");
            TestAssertions.assertTrue(bindings.actionFor(GestureShortcutTrigger.doubleTap()).isOpenMenu(),
                    "double-tap binding must remain available");
            TestAssertions.assertTrue(bindings.actionFor(GestureShortcutTrigger.circle()).isNextTab(),
                    "circle binding must remain available");
        }
    }
    ...
    final class Lookup {
        ...
        void emptyBindingsReturnOffForUnknownTrigger() {
            GestureShortcutAction action = GestureShortcutBindings.empty().actionFor(GestureShortcutTrigger.circle());
    ...
    @Nested
    final class ShapeGestureTracing {
        @Test
        void emptyBindingsHaveNoShapeGestureShortcuts() {
            ...
            TestAssertions.assertFalse(
                    bindings.hasShapeGestureShortcuts(), "empty bindings must not require shape gesture tracing");
        }

        @Test
        void doubleTapOnlyBindingsHaveNoShapeGestureShortcuts() {
            GestureShortcutBindings bindings = GestureShortcutBindings.empty().put(
                    GestureShortcutBinding.of(GestureShortcutTrigger.doubleTap(), GestureShortcutAction.openMenu()));

            TestAssertions.assertFalse(
                    bindings.hasShapeGestureShortcuts(), "double-tap must not require shape gesture tracing");
        }
        ...
        void directionalBindingsHaveShapeGestureShortcutsEvenWhenCircleIsOff() {
            GestureShortcutBindings bindings =
                    GestureShortcutBindings.empty()
                            .put(GestureShortcutBinding.of(
                                    GestureShortcutTrigger.circle(), GestureShortcutAction.off()))
                            .put(GestureShortcutBinding.of(
                                    GestureShortcutTrigger.swipeDown(), GestureShortcutAction.nextTab()));

            TestAssertions.assertTrue(bindings.hasShapeGestureShortcuts(),
                    "directional gestures must keep shape gesture tracing active when circle is off");
        }

        @Test
        void customShapeBindingsHaveShapeGestureShortcuts() {
            GestureShortcutBindings bindings = GestureShortcutBindings.empty().put(
                    GestureShortcutBinding.of(GestureShortcutTrigger.customShape(), GestureShortcutAction.openMenu()));

            TestAssertions.assertTrue(
                    bindings.hasShapeGestureShortcuts(), "custom gestures must keep shape gesture tracing active");
        }
    }
