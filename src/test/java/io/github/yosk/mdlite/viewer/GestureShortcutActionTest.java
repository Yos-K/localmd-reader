...
public final class GestureShortcutActionTest {
    ...
    final class Cycling {
        @Test
        void offActionCyclesToOpenFileForProUsers() {
        ...
        void nextThemeActionCyclesToMoveControlsForProUsers() {
            ...
            TestAssertions.assertTrue(
                    action.isMoveControls(), "Pro double-tap shortcut must cycle from Next theme to Move controls");
        }

        @Test
        void moveControlsActionCyclesToShowSearchForProUsers() {
            GestureShortcutAction action = GestureShortcutAction.moveControls().next(FeatureEntitlement.pro());

            TestAssertions.assertTrue(
                    action.isShowSearchBar(), "Pro double-tap shortcut must cycle from Move controls to Show search");
        }
        ...
        void showSearchBarActionCyclesToNextHeadingForProUsers() {
            ...
            TestAssertions.assertTrue(
                    action.isNextHeading(), "Pro double-tap shortcut must cycle from Show search to Next heading");
        }
        ...
        void nextHeadingActionCyclesToPreviousHeadingForProUsers() {
            ...
            TestAssertions.assertTrue(action.isPreviousHeading(),
                    "Pro double-tap shortcut must cycle from Next heading to Previous heading");
        }
        ...
        void previousHeadingActionCyclesToOffForProUsers() {
            ...
            TestAssertions.assertTrue(
                    action.isOff(), "Pro double-tap shortcut must cycle from Previous heading to Off");
        }
        ...
        void showSearchBarActionCyclesToOffForFreeUsers() {
            ...
            TestAssertions.assertTrue(
                    action.isOff(), "Free double-tap shortcut must skip Pro-only heading jumps after Show search");
        }
        ...
        void freeUsersCanCycleDoubleTapShortcutActions() {
            ...
            TestAssertions.assertTrue(
                    action.isPreviousTab(), "Free entitlement must allow double-tap shortcut action cycling");
        }
    }
    ...
    final class Persistence {
        ...
        void storedValueRestoresOpenMenuAction() {
            ...
            TestAssertions.assertTrue(
                    action.isOpenMenu(), "stored open_menu value must restore the Open menu shortcut");
        }
        ...
        void storedValueRestoresShowSearchBarAction() {
            ...
            TestAssertions.assertTrue(
                    action.isShowSearchBar(), "stored show_search_bar value must restore the Show search shortcut");
        }
        ...
        void storedValueRestoresNextHeadingAction() {
            ...
            TestAssertions.assertTrue(
                    action.isNextHeading(), "stored next_heading value must restore the Next heading shortcut");
        }
        ...
        void storedValueRestoresPreviousHeadingAction() {
            ...
            TestAssertions.assertTrue(action.isPreviousHeading(),
                    "stored previous_heading value must restore the Previous heading shortcut");
        }
    ...
    final class Availability {
        ...
        void freeAvailableActionsExposeDoubleTapChoices() {
            ...
            TestAssertions.assertEquals(
                    8, actions.length, "Free double-tap shortcut picker must expose only Free-safe actions");
            TestAssertions.assertTrue(
                    actions[7].isShowSearchBar(), "Free double-tap shortcut picker must expose Show search directly");
        }
        ...
        void proAvailableActionsExposeMoveControlsAsDirectChoice() {
            ...
            TestAssertions.assertTrue(
                    actions[7].isShowSearchBar(), "Pro gesture shortcut picker must expose Show search directly");
            TestAssertions.assertTrue(
                    actions[8].isNextHeading(), "Pro gesture shortcut picker must expose Next heading directly");
            TestAssertions.assertTrue(actions[9].isPreviousHeading(),
                    "Pro gesture shortcut picker must expose Previous heading directly");
        }
    }
}
