    ...
    final class StatusMessage {
        ...
        void welcomeTabHasNoStatusMessage() {
            ...
            TestAssertions.assertEquals(
                    "", tab.statusMessage().localized(englishText()), "welcome tab must not carry a status message");
        }
        ...
        void fileDocumentTabHasNoStatusMessage() {
            ...
            TestAssertions.assertEquals(
                    "", tab.statusMessage().localized(englishText()), "file document tab must not carry a status message");
        }
