...
public final class ViewerThemeTest {
    ...
    final class Persistence {
        ...
        @MethodSource("io.github.yosk.mdlite.viewer.ViewerThemeTest#themes")
        void storedValueRoundTripsForEveryTheme(String storedValue) {
            ViewerTheme restored = ViewerTheme.fromStoredValue(storedValue);

            TestAssertions.assertEquals(
                    storedValue, restored.storedValue(), "every theme must survive a save/restore round trip");
        }
    }
    ...
    @Nested
    final class EntitlementClamping {
        @Test
    ...
    static Stream<String> themes() {
        return Stream.of(ViewerTheme.LIGHT_VALUE, ViewerTheme.DARK_VALUE, ViewerTheme.AMOLED_VALUE,
                ViewerTheme.GRADIENT_VALUE, ViewerTheme.AURORA_VALUE, ViewerTheme.MIST_VALUE, ViewerTheme.DUSK_VALUE);
    }
}
