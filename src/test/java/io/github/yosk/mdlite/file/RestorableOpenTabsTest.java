...
public final class RestorableOpenTabsTest {
    ...
    @Test
    void fromKeepsStoredTabOrderAndActiveIndex() {
    ...
    @Test
    void fromDropsDuplicateUrisWithoutChangingTheFirstTab() {
        RestorableOpenTabs tabs = RestorableOpenTabs.from(Arrays.asList(
    ...
    @Test
    void fromClampsNegativeActiveIndexToTheFirstTab() {
        RestorableOpenTabs tabs = RestorableOpenTabs.from(Arrays.asList(
                tab("first.md", "content://first"),
    ...
    @Test
    void fromClampsTooLargeActiveIndexToTheLastTab() {
        RestorableOpenTabs tabs = RestorableOpenTabs.from(Arrays.asList(
                tab("first.md", "content://first"),
    ...
    @Test
    void tabUsesFallbackTitleWhenStoredTitleIsBlank() {
