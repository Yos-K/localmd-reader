...
public final class HtmlPageBuilder {
    ...
    public static String buildPage(SafeHtml body, ViewerTheme theme, FontSize fontSize) {
        ...
        return "<!doctype html>"
                ...
                + "table{font-size:" + bodyFontSize + "px;border-collapse:collapse;min-width:max-content;background:" + style.tableCellBackground + ";}"
                ...
                + ".welcome-primary-action{display:block;box-sizing:border-box;width:100%;background:" + style.primary + ";color:" + style.solidBackground + ";text-align:center;text-decoration:none;font-weight:700;border-radius:8px;padding:14px;margin:0 0 14px;}"
