...
public final class WelcomeDocumentBuilder {
    ...
    private static String japaneseHtml() {
        return "<section class=\"welcome\">"
                ...
                + "<div class=\"welcome-card\"><strong>最近開いたファイル</strong><span>この端末で開いた直近5件が残ります。</span></div>"
    ...
    private static String englishHtml() {
        return "<section class=\"welcome\">"
                ...
                + "<div class=\"welcome-grid\">"
                + "<div class=\"welcome-card\"><strong>Recent files</strong><span>Keep the last 5 documents opened on this device.</span></div>"
