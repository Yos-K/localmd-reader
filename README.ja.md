...
LocalMD Reader は現在 Google Play のオープンテストで公開中です。
...
このリポジトリはオープンテストとリリース準備のために public にしています。

完了したクローズドテストの記録は
[docs/release/closed-testing-guide.ja.md](docs/release/closed-testing-guide.ja.md)にあります。
当時のテスター募集文は
